...
namespace Data.Modeler.Providers.SQLServer
{
    ...
    public class SQLServerSchemaGenerator : ISchemaGenerator
    {
        ...
        /// Constructor
        /// </summary>
        public SQLServerSchemaGenerator(IEnumerable<ISourceBuilder> queryBuilders)
        {
        ...
        {
            return BuildCommands(desiredStructure, source).ToArray();
        }
        ...
        public ISource GetSourceStructure(IConnection source)
        {
            ...
            var DatabaseSource = new Connection(source.Configuration, source.Factory, Regex.Replace(source.ConnectionString, "Initial Catalog=(.*?;)", ""), "SourceConnection");
        ...
        {
            var DatabaseSource = new Connection(connection.Configuration, connection.Factory, Regex.Replace(connection.ConnectionString, "Initial Catalog=(.*?;)", ""), "SourceConnection");
