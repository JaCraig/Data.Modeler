...
namespace Data.Modeler.Providers
{
    ...
    /// View class
    /// </summary>
    public class View : TableBase, IFunction
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public override ITable Copy(ISource source) => new View(Name, Schema, Definition, source);
        ...
        IFunction IFunction.Copy(ISource source) => new View(Name, Schema, Definition, source);
